...
func (uh *UserHandler) getusers(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		respondwithJSON(w, http.StatusOK, uh.users)
		return
	}
...
func (uh *UserHandler) postusers(w http.ResponseWriter, r *http.Request) {
	...
	respondwithJSON(w, http.StatusCreated, userses)
}
...
func (ph *PostHandler) getposts(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondwithJSON(w, http.StatusOK, ph.posts)
		return
	}
...
func (ph *PostHandler) postposts(w http.ResponseWriter, r *http.Request) {
	...
	respondwithJSON(w, http.StatusCreated, postses)
}
